        ...
        <div class="col-sm-9"> 
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active show" id="property-list">
                    <p class="pr-3 pl-3 pt-3"><?php _e('Google Maps is a desktop web mapping service developed by Google. It offers satellite imagery, street maps, 360° panoramic views of streets (Street View), real-time traffic conditions (Google Traffic), and route planning for traveling by foot, car, bicycle (in beta), or public transportation. CF GeoPlugin allows you to place google maps easily in your WordPress blog using simple shortcode <code>[cfgeo_map]</code>.',CFGP_NAME); ?></p>
                    <p class="pr-3 pl-3"><?php _e('In the list below are all settings for the <code>[cfgeo_map]</code> shortcode.',CFGP_NAME); ?></p>
                ...
                <div role="tabpane" class="tab-pane fade pb-5" id="info">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p class="manage-menus"><?php printf(__("If you want to place a simple google map in your post or page, you just need to place a shortcode like this: %s - what will show place on Google map by visitors location.",CFGP_NAME),'<br><code>[cfgeo_map]</code>'); ?></p>
                            
                            <p class="manage-menus"><?php printf(__("If you want to display your own company street address inside Google map, you can do that by adding optional attributes %s like on example: %s - what will show your company on Google map.", CFGP_NAME), '<code>longitude</code> and <code>latitude</code>', '<br><code>[cfgeo_map longitude="-74.0059" latitude="40.7128" zoom="15"]</code>' ); ?></p>
