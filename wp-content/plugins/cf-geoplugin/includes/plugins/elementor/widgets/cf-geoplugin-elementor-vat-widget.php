...
class CF_Geoplugin_Elementor_Vat_Widget extends \Elementor\Widget_Base {
	 ...
	 */
	public function get_title() { return __('Value-added tax control', CFGP_NAME); }
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'return_value' => true,
					'default' => true,
					'description' => __( 'You can choose whether to hide or show this widget for the visitors under VAT', CFGP_NAME )
				)
			);
