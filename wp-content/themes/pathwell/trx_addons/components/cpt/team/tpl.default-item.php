...
<div class="sc_team_item">
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters('trx_addons_filter_args_featured', array(
												...
												'hover' => 'zoomin',
												'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size('team'), 'team')
												), 'team-default')
								);
	?>
	<div class="sc_team_item_info">
		...
		?>
		<div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button sc_button_simple', 'sc_team', $args)); ?>"><?php esc_html_e('Learn more', 'pathwell'); ?></a></div>
	</div>
</div>
<?php
