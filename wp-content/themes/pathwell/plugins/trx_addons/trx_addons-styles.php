...
if (!function_exists('pathwell_trx_addons_get_css')) {
	add_filter('pathwell_filter_get_css', 'pathwell_trx_addons_get_css', 10, 4);
	function pathwell_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
CSS;
			...
			$rad = pathwell_get_border_radius();
			$rad4 = ' '.$rad != ' 0' ? '4px' : 0;
			$rad50 = ' '.$rad != ' 0' ? '50%' : 0;
			$css['fonts'] .= <<<CSS
/*
...
.wpb_column .widget_contacts .contacts_info > span:before{
	background-color: {$colors['bg_color']};
}
.widget_contacts .contacts_info > span {
	border-top-color: {$colors['bd_color']}!important;
}
.widget_contacts .contacts_info > span > label{
	color: {$colors['alter_text']};
}
.widget_contacts .contacts_info > span > a{
	color: {$colors['text']};
...
.scheme_dark .sc_title_extra .sc_item_descr {
	color:{$colors['inverse_link']};
}
.sc_icons.sc_icons_modern.sc_icons_size_small .sc_icons_item .sc_icons_icon {
	background-color:{$colors['bd_color']};	
}
.sc_icons.sc_icons_modern.sc_icons_size_small .sc_icons_item .sc_icons_item_title {
	color:{$colors['inverse_link']};
}
.sc_icons.sc_icons_modern.sc_icons_size_small .sc_icons_item:hover .sc_icons_item_description {
	color: {$colors['text_link']};
}
...
.sc_blogger.sc_blogger_plain .sc_blogger_item.has-post-thumbnail .post_meta_item.post_categories a:hover {
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_link']};
}
...
.sc_price.sc_price_default .sc_price_item .sc_price_item_price {
	background-color: {$colors['text_hover']};
}
.sc_price.sc_price_default .sc_price_item .sc_price_wrapper {
	background-color: {$colors['inverse_link']};
}
.sc_price.sc_price_default .trx_addons_column-1_3:nth-child(2) .sc_price_item .sc_price_item_price {
	background-color: {$colors['text_link']};
}
.sc_price.sc_price_default .sc_price_item .sc_price_wrapper ul li {
	border-color: {$colors['bd_color']};
}
...
.sc_services.sc_services_light .sc_services_item_icon:after {
	background-color:{$colors['text_link2']};
}
.sc_services.sc_services_light .sc_services_item:hover .sc_services_item_icon:before {
	color: {$colors['inverse_dark']};
}
.sc_services.sc_services_light .sc_services_item:hover .sc_services_item_icon:after {
	background-color:{$colors['inverse_link']};
}
.sc_services.sc_services_light .sc_services_item .sc_services_item_content {
	color: {$colors['extra_hover2']};
}
.sc_services.sc_services_light .sc_services_item .sc_services_item_title a:hover {
	color: {$colors['text_link']};
}
.scheme_dark .sc_services.sc_services_light .sc_services_item .sc_services_item_title a:hover {
	color: {$colors['text_link2']};
}

.sc_services.sc_services_hover .sc_services_item_icon {
	color: {$colors['text_dark']};
}
.sc_services.sc_services_hover .sc_services_item_icon:after {
	background-color:{$colors['text_link2']};
}
.sc_services.sc_services_hover .sc_services_item:hover .sc_services_item_icon:after {
	background-color:{$colors['inverse_link']};
}
...
.sc_services_hover .sc_services_item_content { color: {$colors['text']};}
.sc_services_hover .sc_services_item_header .sc_services_item_title a { color: {$colors['text_dark']}!important;}
.sc_services_hover .sc_services_item_header .more{ color: {$colors['text_link']};}
.sc_services_hover .sc_services_item_content { 	background-color: {$colors['text_hover']};}
.sc_services_hover .sc_services_item_content .sc_services_item_title a { color: {$colors['inverse_link']}!important;}
.sc_services_hover .sc_services_item_content .sc_services_item_text {color: {$colors['inverse_link']}}
.sc_services_hover .sc_services_item_content .more{ color: {$colors['inverse_link']};}
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3 { border-color: {$colors['bg_color']}; }
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3 .sc_services_item_button a{ color: {$colors['text_dark']}; }
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3 .sc_services_item_button a:not(.sc_services_item_icon):hover { color: {$colors['extra_link']}!important;}
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(1) .sc_services_item_button a.sc_services_item_icon:after,
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(1) .sc_services_item_button a.sc_button,
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(5) .sc_services_item_button a.sc_button,
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(9) .sc_services_item_button a.sc_button { background-color: {$colors['text_link2']}; }
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(2) .sc_services_item_button a.sc_button,
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(6) .sc_services_item_button a.sc_button,
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(7) .sc_services_item_button a.sc_services_item_icon:after, 
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(7) .sc_services_item_button a.sc_button { background-color: {$colors['text_link']}; }
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(3) .sc_services_item_button a.sc_button,
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(4) .sc_services_item_button a.sc_services_item_icon:after,
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(4) .sc_services_item_button a.sc_button,
...
.sc_services.sc_services_modern .trx_addons_columns_wrap .trx_addons_column-1_3:nth-child(8) .sc_services_item_button a.sc_button { background-color: {$colors['text_hover']}; }
