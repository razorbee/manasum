...
if (!function_exists('pathwell_customizer_get_css')) {

	function pathwell_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = pathwell_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('pathwell_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(pathwell_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = pathwell_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = pathwell_customizer_add_theme_colors($colors);
...
a:hover em, a:hover strong, a:hover i, a:hover b {
...
blockquote dt, blockquote b, blockquote strong, blockquote i, blockquote em, blockquote mark, blockquote ins,  blockquote cite {	
...
.sc_content .sc_form input[type="text"],
.sc_content .sc_form input[type="email"],
.sc_content .sc_form textarea,
.sc_content .sc_form textarea.wp-editor-area,

/* Contact Form 7*/
.sc_content .wpcf7 input[type="text"],
.sc_content .wpcf7 input[type="email"],
.sc_content .wpcf7 input[type="tel"],
.sc_content .wpcf7 textarea,
.sc_content .wpcf7 textarea.wp-editor-area {
	border-color: {$colors['input_bg_color']};
	background-color: {$colors['input_bd_color']};
}
.sc_content .wpcf7 input[type="text"]:focus,
.sc_content .wpcf7 input[type="text"].filled,
.sc_content .wpcf7 input[type="email"]:focus,
.sc_content .wpcf7 input[type="email"].filled,
.sc_content .wpcf7 input[type="tel"]:focus,
.sc_content .wpcf7 input[type="tel"].filled,
.sc_content .wpcf7 textarea:focus,
.sc_content .wpcf7 textarea.filled,
.sc_content .wpcf7 textarea.wp-editor-area:focus,
.sc_content .wpcf7 textarea.wp-editor-area.filled {
	color: {$colors['input_dark']};
	border-color: {$colors['input_bd_hover']};
	background-color: {$colors['input_bg_hover']};
}
.sc_content .wpcf7 span[role="alert"] {
	color: {$colors['input_bd_hover']};
}
.sc_content .wpcf7 div.wpcf7-validation-errors, 
.sc_content .wpcf7 div.wpcf7-acceptance-missing {
	border-color: {$colors['input_bd_hover']};
	background-color: {$colors['input_bd_hover']};	
	color: {$colors['bg_color']};
}
.sc_content .wpcf7 div.wpcf7-mail-sent-ok {
	border-color: {$colors['text_hover']};
	background-color: {$colors['text_hover']};	
	color: {$colors['bg_color']};
}
.sc_content .wpcf7-form .trx_addons_column-1_1 p > label,
.sc_content .wpcf7-form .trx_addons_column-1_2 p > label {
	color: {$colors['text_dark']};
	{$fonts['h1_font-family']}
	{$fonts['h1_font-weight']}
}
...
textarea[placeholder]::-webkit-input-placeholder	{ color: {$colors['text']}; }
input[placeholder]::-moz-placeholder,
textarea[placeholder]::-moz-placeholder				{ color: {$colors['text']}; }
input[placeholder]:-ms-input-placeholder,
textarea[placeholder]:-ms-input-placeholder			{ color: {$colors['text']}; }
input[placeholder]::placeholder,
textarea[placeholder]::placeholder					{ color: {$colors['text']}; }
...
.top_panel .sc_button.color_style_link2:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	background-color: {$colors['text_link']};
	color: {$colors['inverse_link']}!important;
} 
...
.post_item.sticky a { color: {$colors['inverse_link']};}
.post_item.sticky.post_item .post_title a:hover,
.post_item.sticky a:hover{ color: {$colors['text_dark']};}

.post_item.sticky.post_layout_excerpt .entry-excerpt a.more-link,
.post_item.sticky.post_layout_excerpt .entry-excerpt .post_meta_item.post_categories a {
	background-color: {$colors['inverse_link']};
	color: {$colors['text_link']};
}
.post_item.sticky.post_layout_excerpt .entry-excerpt a.more-link:hover,
.post_item.sticky.post_layout_excerpt .entry-excerpt .post_meta_item.post_categories a:hover {
	background-color: {$colors['text_hover']};
	color: {$colors['inverse_link']};
}
...
.footer_wrap .sc_layouts_menu > ul > li.current-menu-item > a,
.footer_wrap .sc_layouts_menu > ul > li.current-menu-parent > a,
.footer_wrap .sc_layouts_menu > ul > li.current-menu-ancestor > a {
	color: {$colors['bg_color']} !important;
}
...
.top_panel .sc_layouts_iconed_text .sc_layouts_iconed_text_link:hover .sc_layouts_item_details .sc_layouts_item_details_line1{
	color: {$colors['text_hover']};
}
...
.pathwell_tabs .pathwell_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.pathwell_tabs .pathwell_tabs_titles li.ui-state-active a {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
...
.sheme_self.sidebar .pathwell_tabs .pathwell_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .pathwell_tabs .pathwell_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .pathwell_tabs .pathwell_tabs_titles li.ui-state-active a {
...
.post_layout_excerpt:not(.sticky) { background-color: {$colors['input_bg_hover']};}
.post_layout_excerpt.sticky { background-color: {$colors['text_link']};}
...
.post_layout_excerpt .entry-excerpt .post_meta_item.post_categories a:hover {
	background-color: {$colors['text_hover']};
	color: {$colors['extra_bd_color']};
}
...
.single-post .post_item_single:not(.post_type_product) .post_meta_item.post_categories a:hover{
	background-color: {$colors['text_hover']};
}
.single-post .post_item_single:not(.post_type_product) .post_featured + .post_meta_item.post_categories a{
	background-color: {$colors['extra_bd_color']};
	color: {$colors['text_link']};
}
.single-post .post_item_single:not(.post_type_product) .post_featured + .post_meta_item.post_categories a:hover{
	background-color: {$colors['text_hover']};
	color: {$colors['extra_bd_color']};
}
...
.related_wrap .related_item_style_2 .post_featured .post_categories a:hover{
	background-color: {$colors['text_hover']}; 
	color: {$colors['inverse_link']};
}
...
.sc_title.scheme_dark .sc_item_descr {
	color: {$colors['text_dark']};
}
.tparrows {
	color: {$colors['bg_color']};
...
CSS;
					...
					$rez = apply_filters('pathwell_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'pathwell_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>