...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Pathwell'.
Please install and activate it before starting to use the theme Pathwell.
...
Theme documentation is available on http://Pathwell.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Pathwell is Fontello.
